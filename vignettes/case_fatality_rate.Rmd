...
This case study investigates World Health Organisation (WHO) estimates of the case fatality ratio for Tuberculosis (TB) in 2016. It then estimates case fatality rates using a simple approximation and compares the results to the WHO estimates. It was adapted from [this](https://www.samabbott.co.uk/post/est-cfr-gettbinr/) blog post. 
...
A key component of TB control is reducing the case fatality rate from active TB, this post explores WHO estimates for the TB case fatality rate in 2016 and then estimates the case fatality rates in previous years. The first step is to download and install the required packages.
