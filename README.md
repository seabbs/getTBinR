...
#> Saving data to: /tmp/RtmpUdbkpc/TB_data_dict.rds
...
getTBinR::plot_tb_burden_overview(metric = "e_inc_100k",
                                  ...
                                  interactive = FALSE)
#> Loading data from: /tmp/RtmpUdbkpc/TB_burden.rds
#> Loading data from: /tmp/RtmpUdbkpc/MDR_TB.rds
#> Joining TB burden data and MDR TB data.
#> Joining, by = c("country", "iso2", "iso3", "iso_numeric", "year")
#> Loading data from: /tmp/RtmpUdbkpc/TB_data_dict.rds
#> 1 results found for your variable search for e_inc_100k
```
