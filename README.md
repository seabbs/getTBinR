...
getTBinR::plot_tb_burden_overview(metric = "e_inc_100k",
                                  ...
                                  interactive = FALSE)
#> Loading data from: /tmp/RtmpHDyAQo/TB_burden.rds
#> Loading data from: /tmp/RtmpHDyAQo/MDR_TB.rds
#> Joining TB burden data and MDR TB data.
#> Loading data from: /tmp/RtmpHDyAQo/TB_data_dict.rds
#> 1 results found for your variable search for e_inc_100k
```
