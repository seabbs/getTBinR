...
#> Saving data to: /tmp/RtmpXFS3zb/TB_burden.rds
#> Downloading data from: https://extranet.who.int/tme/generateCSV.asp?ds=dictionary
#> Saving data to: /tmp/RtmpXFS3zb/TB_data_dict.rds
...
getTBinR::plot_tb_burden_overview(metric = "e_inc_100k",
                                  ...
                                  interactive = FALSE)
#> Loading data from: /tmp/RtmpXFS3zb/TB_burden.rds
#> Loading data from: /tmp/RtmpXFS3zb/TB_data_dict.rds
#> 1 results found for your variable search for e_inc_100k
```
...
Or accessed [online](http://www.seabbs.co.uk/shiny/ExploreTB). Any metric in the WHO data can be explored, with country selection using the built in map, and animation possible by year.
