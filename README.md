...
Get WHO Tuberculosis Data in R <img src="man/figures/logo.png" align="right" alt="" width="120" />
==================================================================================================
...
getTBinR::plot_tb_burden_overview(metric = "e_inc_100k",
                                  ...
                                  interactive = FALSE)
#> Loading data from: /tmp/Rtmpsi6Y7K/TB_burden.rds
#> Loading data from: /tmp/Rtmpsi6Y7K/MDR_TB.rds
#> Joining TB burden data and MDR TB data.
#> Loading data from: /tmp/Rtmpsi6Y7K/TB_data_dict.rds
#> 1 results found for your variable search for e_inc_100k
```
